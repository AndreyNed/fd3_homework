                    ...
                    <div className = { `${ this.classCSS }_content` }
                        ...
                        <div className="rows sections"
                            ...
                            <div className="cols col_16">
                                ...
                                <p key="7">
                                    <strong>Клиентская часть</strong> - одностраничное приложение ( SPA ). Язык разработки - <strong>Javascript</strong>, с использованием <strong>React / Redux</strong>.
                                </p>
                                <p key="8">
                                    <strong>Все компоненты проекта являются собственной оригинальной разработкой</strong>.
                                </p>
                                <p key="9">
